<?php
// HTTP
define('HTTP_SERVER', 'http://'. $_SERVER['HTTP_HOST'] .'/webantam/');

// HTTPS
define('HTTPS_SERVER', 'http://'. $_SERVER['HTTP_HOST'] .'/webantam/');

// DIR
define('DIR_APPLICATION', $_SERVER['DOCUMENT_ROOT'].'/webantam/catalog/');
